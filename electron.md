...
- [ ] Create production application icons and metadata.
- [ ] Configure bundle ID and protocol registration.
...
- [ ] Produce a DMG or ZIP installer.
- [ ] Test installation, first launch, Gatekeeper, protocol registration, upgrade, and uninstall on a clean Mac user account.
- [ ] Add crash reporting only after documenting privacy and redaction behavior.
- [ ] Decide and document update distribution before enabling automatic updates.

Exit criteria: a clean macOS machine can install, launch, authenticate, update or reinstall, and remove SigNote without bypassing platform security warnings.
