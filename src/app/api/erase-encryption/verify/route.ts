...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const expectedStatement = `By signing this message I agree to erase my encryption profile and all secrets and seals associated with account ${sessionAddress}`;
