export default [
  ...
  { inputs: [], name: "NoChange", type: "error" },
  ...
  { inputs: [], name: "ZeroDecimalsPaymentToken", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "address[]", name: "paymentTokens_", type: "address[]" },
      { internalType: "uint128", name: "passPrice_", type: "uint128" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "isPaymentToken", type: "bool" },
    ],
